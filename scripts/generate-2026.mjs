...
const events = [
  ...
  // Civic, remembrance, and public-theme days commonly shown in mainland calendars.
  event("2026-01-10", "中国人民警察节", "纪念日"),
  event("2026-03-05", "学雷锋纪念日", "纪念日"),
  event("2026-03-15", "消费者权益日", "常用纪念日"),
  event("2026-04-15", "全民国家安全教育日", "纪念日"),
  event("2026-04-22", "世界地球日", "常用纪念日"),
  event("2026-04-23", "世界读书日", "常用纪念日"),
  event("2026-04-24", "中国航天日", "纪念日"),
  event("2026-05-12", "全国防灾减灾日", "纪念日"),
  event("2026-05-12", "国际护士节", "常用纪念日"),
  event("2026-05-17", "全国助残日", "纪念日"),
  event("2026-05-18", "国际博物馆日", "常用纪念日"),
  event("2026-05-30", "全国科技工作者日", "纪念日"),
  event("2026-06-05", "世界环境日", "常用纪念日"),
  event("2026-06-06", "全国爱眼日", "纪念日"),
  event("2026-06-14", "世界献血者日", "常用纪念日"),
  event("2026-06-25", "全国土地日", "纪念日"),
  event("2026-07-07", "七七事变纪念日", "纪念日"),
  event("2026-07-11", "中国航海日", "纪念日"),
  event("2026-08-08", "全民健身日", "纪念日"),
  event("2026-08-15", "日本宣布无条件投降日", "纪念日"),
  event("2026-08-19", "中国医师节", "纪念日"),
  event("2026-09-03", "中国人民抗日战争暨世界反法西斯战争胜利纪念日", "纪念日"),
  event("2026-09-18", "九一八事变纪念日", "纪念日"),
  event("2026-09-19", "全民国防教育日", "纪念日"),
  event("2026-09-23", "中国农民丰收节", "纪念日"),
  event("2026-09-30", "烈士纪念日", "纪念日"),
  event("2026-10-13", "中国少年先锋队建队日", "纪念日"),
  event("2026-10-16", "世界粮食日", "常用纪念日"),
  event("2026-10-25", "抗美援朝纪念日", "纪念日"),
  event("2026-11-08", "记者节", "常用纪念日"),
  event("2026-11-09", "全国消防日", "纪念日"),
  event("2026-12-02", "全国交通安全日", "纪念日"),
  event("2026-12-04", "国家宪法日", "纪念日"),
  event("2026-12-09", "一二·九运动纪念日", "纪念日"),
  event("2026-12-13", "南京大屠杀死难者国家公祭日", "纪念日"),
  event("2026-12-20", "澳门回归纪念日", "纪念日"),
];
